...
```bash
curl -X POST https://backend.yourdomain.com/api/analytics/pull-metrics \
...
curl -X POST https://backend.yourdomain.com/api/analytics/feedback-loop \
...
```bash
# Test backend health
curl https://backend.yourdomain.com/health/db
